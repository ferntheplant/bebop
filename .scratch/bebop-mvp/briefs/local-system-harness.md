...
[What breaks when real Bebop and Swordfish processes run together locally?](../issues/real-process-local-protocol.md) into a maintained, one-command local harness.
...
- resolving the SSE keepalive decision in [the SSE keepalive ticket](../issues/sse-keepalive-and-the-http-idle-timeout.md);
