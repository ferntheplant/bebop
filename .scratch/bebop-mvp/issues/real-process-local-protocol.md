...
the already-open [SSE keepalive ticket](./sse-keepalive-and-the-http-idle-timeout.md). None of these observations requires a new protocol decision or ADR.

Implementation brief: [a production-quality local system harness](../briefs/local-system-harness.md).
