...
unmergeable. If it does, the bounty returns to `building` with feedback and ein merges base back in; if it does
not, "behind base by N" is surfaced and nothing reruns.
