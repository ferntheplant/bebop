 ...
 *
 * Bebop stores tokens hashed (`docs/design/SYSTEM.md` §17.4), so the plaintext exists exactly once, in
...
// Health carries no bearer middleware. `docs/design/SYSTEM.md` §24 puts health-checked blue/green
