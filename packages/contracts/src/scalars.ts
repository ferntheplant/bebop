...
const SafeIdentifier = Schema.String.pipe(
  Schema.check(Schema.isMinLength(1), Schema.isMaxLength(128), Schema.isPattern(/^[A-Za-z0-9][A-Za-z0-9._:-]*$/)),
);

export const BountyId = Schema.String.pipe(
  Schema.check(Schema.isMinLength(1), Schema.isMaxLength(63), Schema.isPattern(/^[a-z0-9][a-z0-9-]*$/)),
